...
Without the permission, Handsfree won't be able to perform much of its job, as it won't be able to see a call in progress to show you the call status on the watch, neither it would be able to hang up a call on your request from the watch.
...
To be able to serve your request while working in background, Handsfree needs the permission to show you a notification. This is a measure for you to be sure that it's running in the background/awaiting your requests from the watch. It also shows you a bit of current status of the connection to your watch.
